...
using Lykke.Job.Dynamic.Settings;
using Lykke.Job.Dynamic.Modules;
using Lykke.Logs;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                builder.RegisterModule(new JobModule(appSettings.CurrentValue.DynamicJob, appSettings.Nested(x => x.DynamicJob), Log));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime appLifetime)
        {
            try
            {
                ...
                app.UseLykkeMiddleware("Dynamic", ex => new ErrorResponse {ErrorMessage = "Technical problem"});
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            var persistenceManager = new LykkeLogToAzureStoragePersistenceManager(
                AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "DynamicLog", consoleLogger),
                consoleLogger);
